...
namespace CustomTitleBarPOC.Extensions
{
    public static class WindowSizing
    {
        ...
        private static IntPtr WindowProc(IntPtr hwnd, int msg, System.IntPtr wParam, System.IntPtr lParam, ref bool handled)
        {
            switch (msg)
            {
                case 0x0024:
        ...
        //    MARGINS margins = new MARGINS { Left = -1, Right = -1, Top = -1, Bottom = 50 };
        //    DwmExtendFrameIntoClientArea(hWnd, ref margins);
        //}

        //public static void HandleLocationChanged(Window window)
        //{
